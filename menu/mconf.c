...
"Overview\n"
"--------\n"
"Some features may be built directly into  LFS KIT .  Some features\n"
...
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different  LFS KIT \n"
	"configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than the\n"
	" LFS KIT 's default, entering the name of the file here will allow you\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different  LFS KIT \n"
	"configurations available on a single machine.\n"
	"\n"
...
search_help[] =
	...
	"o The 'Selects:' line tell what symbol will be  LFS KIT matically\n"
...
int main(int ac, char **av)
{
	...
	sym_calc_value(sym);
	snprintf(menu_backtitle, 128, " LFS KIT  v%s Configuration",
		sym_get_string_value(sym));
	...
	do {
		stat = dialog_yesno(NULL,
				    "Do you wish to save your new  LFS KIT  configuration?", 5, 60);
	} while (stat < 0);
	end_dialog();
	...
	if (stat == 0) {
		conf_write(NULL);
		printf("\n"
			"*** End of  LFS KIT  configuration.\n");
	} else
		printf("\n\nYour  LFS KIT  configuration changes were NOT saved.\n\n");
